...
const getArticle = () => {
  ...
  detailArticle(
    ...
    ({ data }) => {
      ...
      article.value.board_img = data.user_img; //글을 작성한 유저의 프로필 사진
      // article.value.fileInfos = data.fileInfos; //
      console.log(article.value.board_img);
    },
    (error) => {
      console.log(error);
    }
    ...
    <div class="row justify-content-center">
      ...
      <div class="col-lg-10 text-start mt-3">
        <div class="row">
          <div class="col">
            <div class="col mb-3">
              <img class="avatar me-2" v-if="article.board_img" :src="article.board_img" />

              <span class="fw-bold p-3">{{ article.user_name }}</span>
              <span class="text-secondary fw-light m-1"> {{ article.board_write_time }}</span>
              <div class="float-end">
                ...
                <span class="m-1">{{ article.board_hit }} </span>
              </div>
              <div class="float-end">
